...
class InstructorExport implements FromQuery, WithMapping, WithHeadings, WithChunkReading, WithStyles, ShouldAutoSize, WithProperties
{
    use Exportable;
    ...
    {
        $query = Instructor::select('instructors.*');
