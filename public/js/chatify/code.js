    ...
    if (messenger != 0) {
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                if (data.fetch.participant && data.fetch.participant.name) {
                    nameToDisplay = data.fetch.participant.name;
                } else if (data.fetch.instructor && data.fetch.instructor.name) {
                    nameToDisplay = data.fetch.instructor.name;
                } else {
                    nameToDisplay = data.fetch.email;
                }
                $(".messenger-infoView .info-name").text(nameToDisplay);
                $(".m-header-messaging .user-name").text(nameToDisplay);
                // Star status
                data.favorite > 0
