@section('title', 'Edit Meeting Kursus')
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('dashboard.meeting.update', $meeting->id) }}"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="link" class="mt-1 w-full" type="text" name="link"
                            :value="old('link', $meeting->link)" required autofocus autocomplete="link" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="type" class="mt-1 w-full" type="text" name="type"
                            :value="old('type', $meeting->type)" required autofocus autocomplete="type" placeholder="Google Meet" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.select-input id="day" class="mt-1 w-full" name="day" required autofocus>
                            ...
                            @foreach ($days as $day)
                                <option value="{{ $day }}"
                                    {{ old('day', $meeting->schedules->day) == $day ? ' selected' : ' ' }}>
                                    {{ $day }}</option>
                            @endforeach
                        </x-input.select-input>
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="start_time" class="mt-1 w-full" type="time" name="start_time"
                            :value="old('start_time', $meeting->schedules->start_time)" required autofocus autocomplete="start_time" placeholder="Google Meet" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="end_time" class="mt-1 w-full" type="time" name="end_time"
                            :value="old('end_time', $meeting->schedules->end_time)" required autofocus autocomplete="end_time" placeholder="Google Meet" />
