@section('title', 'Tambah Kuis Materi')
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('dashboard.quiz.store') }}" class="md:grid md:grid-cols-2 gap-4"
                    ...
                    <div class="mt-4">
                        <x-input.input-label for="title" :value="__('Judul Kuis')" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="end_time" class="mt-1 w-full" type="datetime-local" name="end_time"
                            :value="old('end_time')" required autofocus autocomplete="end_time" disabled />
            ...
            $(document).ready(function() {
                ...
                startDateInput.addEventListener('change', function() {
                    ...
                    if (startDateInput.value) {
                        // Enable end date and set minimum date to start date
