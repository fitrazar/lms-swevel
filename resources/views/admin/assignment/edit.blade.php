            ...
            <x-card.card-default class="static">
                ...
                <x-form action="{{ route('dashboard.assignment.update', $assignment->id) }}" method="POST"
                    ...
                    <div class="mt-4">
                        ...
                        <x-input.text-input id="deadline" class="mt-1 w-full" type="text" name="deadline"
                            :value="old('deadline', $assignment->deadline)" required autofocus autocomplete="deadline" />
